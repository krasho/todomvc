...
/***/ function(module, exports, __webpack_require__) {
	...
	var SPARouter   = __webpack_require__(159);
	  ...
	  render: function(){
	    return (
	      React.createElement("div", null, 
	        ...
	        React.createElement(Content, {dataSource: Task[this.state.context]()}), 
	        React.createElement(Footer, {context: this.state.context, pending: this.state.pending})
	      )
	    );
	  }
	});

	React.render(React.createElement(App, null), document.getElementsById('todoapp')[0]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Hamsa = __webpack_require__(163);
	var Task;
	   ...
	   render: function() {
	     return(
	        React.createElement("section", {className: "main"}, 
	           React.createElement("input", {className: "toggle-all", type: "checkbox", onClick: this.onToggle}), 
	           React.createElement("label", {htmlFor: "toggle-all"}, "Mark all as completed "), 

	           React.createElement("ul", {className: "todo-list"}, 
	            
	               this.props.dataSource.map(function(item, index){
	                 return (React.createElement(Todo, {key: item.uid, data: item}));     
	               })
	    ...
	    return(
	       React.createElement("li", {className: className}, 
	          React.createElement("div", {className: "view"}, 
	             ...
	             React.createElement("label", {onDoubleClick: this.onEdit}, 
	                this.state.value
	             ), 

	             React.createElement("button", {className: "destroy", onClick: this.onDestroy})
	          ), 

	          React.createElement("input", {type: "text", className: "edit", value: this.state.value, 
	    ...
	    return(
	       React.createElement("footer", {className: "footer"}, 
	          React.createElement("span", {className: "todo-count"}, 
	             React.createElement("strong", null, this.props.editing), 
	             "item  \\ left"
	          ), 
	            ...
	            this.state.contexts.map(function(item, index) {
	              ...
	              return (
	                 React.createElement("li", null, 
	                    React.createElement("a", {className: className, href: item.href}, 
	                    item.caption
	                    )
	                 )
	              )
	          ...
	          React.createElement("button", {className: "clear-completed", onClick: this.onClearCompleted}, 
	             "Clear Completed"
	          )
	       )
